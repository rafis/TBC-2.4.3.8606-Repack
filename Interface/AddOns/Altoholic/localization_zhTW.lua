...
L:RegisterTranslations("zhTW", function() return {
	...
	["Character %s successfully deleted"] = "角色 %s 刪除成功",
	["Suggested leveling zone: "] = "建議升級的地區",
	["Arena points: "] = "兢技場分數",
	["Honor points: "] = "榮譽分數",
	
	-- AuctionHouse.lua
	[" has no auctions"] = " 沒有拍賣",
	[" has no bids"] = " 沒有競標",
	["last check "] = "前次的撿查 ",
	["Goblin AH"] = "中立拍賣場",
	["Clear your faction's entries"] = "清除現有陣營的項目",
	["Clear goblin AH entries"] = "清除中立拍賣場的項目",
	["Clear all entries"] = "清除所有的項目",
	...
	["Miscellaneous"] = "其他",
	["Fishing Poles"] = "魚竿",
	["This realm"] = "只搜索本伺服器",		-- please update these 3 string to display "this realm" instead of "search this realm" ...
	["All realms"] = "搜索所有伺服器",
	["Loot tables"] = "搜索物品掉落表",
