...
Altoholic.Suggestions = {
	...
	[BI["Tailoring"]] = {
		...
		{ 360, "Up to 360: Netherweave Tunic\n|cFFFFD700Disenchant them for Arcane Dust" },
		{ 375, "Up to 375: Imbued Netherweave Tunic\nCraft your specialization set" }
	},
	[BI["Leatherworking"]] = {
		...
		{ 355, "Up to 355: Felscale Breastplate" },
		{ 365, "Up to 365: Heavy Clefthoof Boots\n|cFFFFD700Grind Clefthoof Leather in Nagrand" },
		{ 375, "Up to 375: Drums of Battle\n|cFFFFD700Requires The Sha'tar - Honored" }
	},
	[BI["Engineering"]] = {
		...
		{ 360, "Up to 360: Khorium Power Core\nMake 20 of them, you'll need them to reach 375" },
		{ 375, "Up to 375: Field Repair Bot 110G" }
	},
	[BI["Jewelcrafting"]] = {
	...
	[BF["Cenarion Expedition"]] = {
		{ 3000, "Up to Friendly:\n\n" 
				...
				.. "|rRun any " .. GREEN .. "Coiffang|r instance\n\n"
		...
		{ 9000, "Up to Honored:\n\n" 
				...
				.. "|rRun any " .. GREEN .. "Coiffang|r instance" },
		{ 42000, "Up to Exalted:\n\n" 
				.. WHITE .. "Turn in [Coiffang Armaments] +75 rep\n\n"
				.. GREEN .. "Steamvault |r(Normal)\n"
				.. GREEN .. "Any Coiffang instance |r(Heroic)" }
	},
	[BF["Keepers of Time"]] = {
		{ 42000, "Up to Exalted:\n\n" 
